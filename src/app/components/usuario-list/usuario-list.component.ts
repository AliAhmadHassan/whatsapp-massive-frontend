...
export class UsuarioListComponent implements OnInit {
  ...
  findByEmpresaId(page: number, count: number, empresaId: number){
    this.usuarioService.findByEmpresaId(page, count, empresaId).subscribe((responseApi: ResponseApi) => {
  ...
  delete(id:number){
    this.dialogService.confirm('Do you want to delete the usuario ?')
